...
struct Constants {
    static let API_KEY = "1931133b575fcbfff855d658ec4d3b75"
    static let baseUrl = "https://api.themoviedb.org"
    static let Youtube_API_KEY = "AIzaSyCBhYqotGDXhj5d1hNasO9fBa8-4D90YtY"
    static let YoutubeBaseKey = "https://youtube.googleapis.com/youtube/v3/search?"
}
enum APIError: Error {
...
class APICaller{
    ...
    func getMovie(with query : String,completion : @escaping (Result <VideoElement, Error>) -> Void){
       ...
       guard let url = URL(string: "\(Constants.YoutubeBaseKey)q=\(query)&key=\(Constants.Youtube_API_KEY)") else{return}
